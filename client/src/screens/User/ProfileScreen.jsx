    ...
    <>
      <section className="min-h-screen flex flex-col sm:flex-row justify-center items-center pt-16 px-5 sm:px-16 space-y-5 sm:space-y-0 sm:space-x-5">
        {loading || orderLoading ? (
          ...
          userDetails && (
            <>
              <div className="flex flex-col justify-center items-center p-4 rounded-2xl w-full sm:w-1/3 border border-green-300">
              ...
              <div className="flex flex-col justify-center items-center w-full sm:w-2/3">
                {orderListByUserId.length > 0 ? (
                  ...
                  <div className="w-full text-4xl text-center font-bold text-green-600 border-2 border-green-500 rounded-2xl p-4">
                    No Orders Found!
                  </div>
                )}
              </div>
