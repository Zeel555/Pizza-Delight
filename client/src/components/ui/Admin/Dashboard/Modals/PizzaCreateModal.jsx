    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h2 className="w-full text-xl text-green-800 font-bold border-b border-b-green-300">
            Create Pizza
          </h2>
          ...
          {loading || pizzaLoading ? (
            ...
            <div className="flex flex-col items-center justify-center w-full">
              ...
              >
                <div className="w-full grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      disabled={loading}
                      required
                      className="w-full text-green-800 bg-green-100 placeholder-green-600 rounded-md p-4 pr-12 text-sm shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                    />
                  </div>
                  <div className="w-full">
                ...
                <div className="w-full flex flex-col items-center justify-center bg-green-100 rounded-md p-4">
                  <h1 className="text-xl font-bold text-green-800">Size</h1>
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    {PizzaSizes.map((size, index) => (
                      <label
                        key={index}
                        htmlFor={size}
                        className="flex flex-row items-center justify-center text-white rounded-full bg-green-600 p-2"
                      >
                        <input
                          type="radio"
                          className="mr-2"
                      ...
                      switch (category) {
                        case 'bases':
                          return (
                            <div
                              key={category}
                              className="w-full flex flex-col items-center justify-center bg-green-100 rounded-md p-4"
                            >
