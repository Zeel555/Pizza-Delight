  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="text-black hover:text-green-500 border-2 border-green-500 rounded-full inline-flex items-center p-2 focus:outline-none"
      >
        <FaUserAlt />
        <BiSolidDownArrow className="h-3 text-green-300" />
      </button>
      {dropIsOpen && (
        <div className="absolute right-0 w-48  bg-white border border-gray-300 rounded shadow-lg mt-4">
          {adminUserInfo && (
            <Link
              ...
              className="inline-flex items-center w-full px-4 py-2 text-sm text-left text-green-600 hover:bg-green-100"
            >
