  ...
  return (
    <form onSubmit={submitHandler} className="w-full p-4">
      <p className="text-center text-black text-xl leading-relaxed">
        Shipping
        <br />
        <span className="text-sm text-green-600">Enter Shipping Details</span>
      </p>
            ...
            <div className="w-full">
              ...
              <div className="flex justify-center items-center w-full">
                <input
                  ...
                  required
                  className="w-full text-green-600 bg-green-100 placeholder-green-300 rounded-md p-4 pr-12 text-sm shadow-sm"
                />
              </div>
            </div>
