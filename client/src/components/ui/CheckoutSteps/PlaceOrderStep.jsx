    ...
    <div className="flex flex-col justify-between items-center mb-4">
      ...
      <>
        {loading ? (
          ...
          <div className="w-full flex flex-col items-center justify-center border border-green-300 rounded-2xl p-4 mt-2 space-y-4 md:flex-row md:space-y-0 md:space-x-6">
            <div className="flex flex-col items-start justify-between w-full md:w-2/3">
              <div className="flex flex-col items-start justify-between w-full py-2">
                ...
                <p className="text-green-600 text-md leading-relaxed">
              ...
              <div className="flex flex-col items-start justify-between w-full md:w-2/3 border-y border-y-green-300 py-2">
                <h2 className="text-center text-black text-xl leading-relaxed">
                  Payment Method
                </h2>
                <p className="text-green-600 text-md leading-relaxed">
              ...
              <div className="flex flex-col items-start justify-between w-full md:2/3 py-2 ">
                ...
                <div className="flex flex-col items-start justify-between w-full space-y-2">
                  {cartItems.map((item) => (
                    <div
                      key={item._id}
                      className="flex flex-col sm:flex-row items-center justify-between w-full space-x-5 border-b border-green-300 py-2"
                    >
                      <img
                        src={item.imageUrl}
                        alt={item.name}
            ...
            <div className="flex flex-col items-center justify-between border-2 border-green-300 rounded-2xl p-4 sm:w-1/3">
              <h2 className="text-center text-black text-xl leading-relaxed">
                Order Summary
              </h2>
              <div className="w-full flex flex-col items-center justify-between my-2 space-y-1">
                {orderSummary.map((item) => (
                  <div
                    key={item.name}
                    className="flex flex-row items-center justify-between w-full border-t border-green-300"
                  >
                    <p className="text-black text-md leading-relaxed">
                      {item.name}
                    </p>
          ...
          <div className="flex flex-col items-center justify-center w-full">
            <p className="text-center text-green-600 text-xl leading-relaxed">
